    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h3>Data Hasil Koreksi Jawaban Pilihan Ganda (PG) Siswa</h3>   
                    </div>
                </div>
				...
				if(isset($_GET['pesan'])){
					...
					<tr>
						...
						<td><center>
							<a class="btn btn-primary btn-xs" href="hasilkoreksi.php?id=<?php echo $id; ?>"><span class ="glyphicon glyphicon-file"></span> Lihat Hasil Koreksi</a>					
						</center></td>
					</tr>
					<?php } ?>
				</tbody>
